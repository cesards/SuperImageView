...
public class ForegroundSuperImageView extends SuperImageView {
  ...
  // Constructors
  public ForegroundSuperImageView(Context context) {
    super(context);
  }

  public ForegroundSuperImageView(Context context, AttributeSet attrs) {
    this(context, attrs, 0);
  }

  public ForegroundSuperImageView(Context context, AttributeSet attrs, int defStyle) {
