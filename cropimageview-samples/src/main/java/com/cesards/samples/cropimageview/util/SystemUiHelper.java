...
package com.cesards.samples.cropimageview.util;
...
public final class SystemUiHelper {
  ...
  /**
   * Show the system UI. What this means depends on the mode this {@link android.example.android.systemuivis.SystemUiHelper}
   * was
   * instantiated with.
   *
  ...
  /**
   * Hide the system UI. What this means depends on the mode this {@link android.example.android.systemuivis.SystemUiHelper}
   * was
   * instantiated with.
   *
   * <p>Any currently queued delayed hide requests will be removed.
